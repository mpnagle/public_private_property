...
* TODO Write script to digitize Boston parcel data		      :aresnick:
  DEADLINE: <2009-02-26 Thu>
* TODO Buy subscription to Boston parcel data			      :aresnick:
  DEADLINE: <2009-02-25 Wed>
* TODO Get updated Boston parcel data				      :aresnick:
  DEADLINE: <2009-02-25 Wed>
* TODO Fill out data-blossom project spec			      :aresnick:
